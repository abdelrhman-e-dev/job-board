...
- Administrative back-office for managing job postings and categories
- Role-based user access control with defined capabilities matrix
- Job vacancy management system
- Job category management
- User management and authentication
- Admin dashboard with Filament integration
- Data persistence with MariaDB database
...
- MariaDB (database)
- Spatie Laravel Settings Plugin (configuration management)
