    <div class="min-h-screen bg-neutral-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8"
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <div class="relative bg-white py-8 px-4 shadow-lg sm:rounded-xl sm:px-10 border border-neutral-200 min-h-[400px]">
                <!-- Full-form loader overlay when submitting -->
                <div wire:loading.flex wire:target="submit" class="absolute inset-0 z-50 flex-col items-center justify-center bg-white/95 backdrop-blur-sm sm:rounded-xl">
                    ...
                    <p class="text-xl font-bold text-neutral-900">Creating your account...</p>
                    <p class="text-sm text-neutral-500 mt-2 font-medium">Please wait a moment.</p>
                </div>
                    ...
                    <form class="space-y-5" wire:submit="nextStep">
                        ...
                        <div>
                            <button type="submit" wire:loading.attr="disabled" wire:target="nextStep"
                                class="w-full flex justify-center items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors disabled:opacity-75 disabled:cursor-not-allowed">
                                <span wire:loading.remove wire:target="nextStep">Next: Company Info →</span>
                                <span wire:loading.flex wire:target="nextStep" class="items-center">
                    ...
                    <form class="space-y-5" wire:submit="submit">
                        ...
                        <div class="pt-2">
                            <button type="submit" wire:loading.attr="disabled" wire:target="submit"
                                class="w-full flex justify-center items-center py-2.5 px-4 border border-transparent rounded-md shadow-sm text-sm font-semibold text-white bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all disabled:opacity-75 disabled:cursor-not-allowed">
