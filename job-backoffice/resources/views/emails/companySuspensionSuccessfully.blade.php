...
<div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 20px auto; padding: 20px; border: 1px solid #e1e1e1; border-radius: 10px;">
    ...
    <p style="font-size: 16px;">We are writing to inform you that your company account has been suspended effective immediately.</p>
    <p style="font-size: 16px;">If you believe this suspension was made in error or have questions about this action, please reach out to our support team. We're here to help resolve any concerns.</p>
